        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center space-x-6">
              <a href="/debates" className="text-muted-foreground hover:text-foreground transition-colors">
                Debates
              </a>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Card className="hover:shadow-lg transition-all duration-300">
              <CardHeader>
                ...
                <CardTitle className="font-sans">Privacy vs Security in the Digital Era</CardTitle>
                <CardDescription className="font-serif">
            ...
            <Card className="hover:shadow-lg transition-all duration-300">
              <CardHeader>
                ...
                <CardTitle className="font-sans">Mental Health: A Universal Right?</CardTitle>
                <CardDescription className="font-serif">
